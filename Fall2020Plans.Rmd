...
ggplot(List, aes(y = Region)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE)) +
  labs(title="Colleges fall 2020 call by Region", caption = "Data from The Chronicle of Higher Education on 6/16/2020") +
  theme_few()
...
ggplot(List, aes(y = Division)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE)) +
  labs(title="Colleges fall 2020 call by Division", caption = "Data from The Chronicle of Higher Education on 6/16/2020") +
  theme_few()
...
ggplot(List, aes(y = Control)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE))  +
  labs(title="Public vs. Private school fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/16/2020") +
  theme_few()
...
ggplot(List, aes(y = Call)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE))  +
  labs(title="All schools fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/16/2020") +
  theme_few()
...
ggplot(WomenOnly, aes(y = Call)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE)) +
  labs(title="Historically Women's Colleges fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/16/2020") +
  theme_few()
...
ggplot(MassOnly, aes(y = Call)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE)) +
  labs(title="Massachusetts schools fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/16/2020") +
  theme_few()
```
...
ggplot(List, aes(x = ADM_RATE, y = MEDIAN_HH_INC, color = Call)) +
  ...
  labs(title="Median Household Income, acceptance rate, and fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/16/2020") +
  theme_few()
...
ggplot(List, aes(x = ADM_RATE, y = PCT_BORN_US, color = Call)) +
  ...
  scale_y_continuous(trans = 'log10') +
  ylim(65,100) +
  labs(title="Percent of students born in the U.S., acceptance rate, and fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/16/2020") +
  theme_few()
...
ggplot(SelectiveSchool, aes(y = Region)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE))+
  labs(title="Selective schools fall 2020 call by region", caption = "Data from The Chronicle of Higher Education on 6/16/2020") +
  theme_few()
...
ggplot(MassOnly, aes(y = Call)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE)) +
  labs(title="Massachusetts selective schools fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/16/2020") +
  theme_few()
