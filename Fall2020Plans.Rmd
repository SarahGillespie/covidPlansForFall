...
ggplot(List, aes(y = Control)) +
 geom_bar(aes(fill = Decision), position = position_stack(reverse = FALSE))  +
  labs(title="Public vs. Private school fall 2020 Decision", caption = "Data from The Chronicle of Higher Education on 6/18/2020") +
  theme_few() +
  xlab("Number of schools") +
  ylab(" ")
...
ggplot(List, aes(x = ADM_RATE, y = MEDIAN_HH_INC, color = Decision)) +
  geom_point() +
...
# ggplot(SelectiveSchool, aes(y = Decision)) +
#  geom_bar(aes(fill = Decision), position = position_stack(reverse = FALSE))
...
# ggplot(SelectiveSchool, aes(x = ADM_RATE, y = percR, color = Decision)) +
#   geom_point()
