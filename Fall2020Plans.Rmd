...
fall2020dataCoHEJun17 <- read_csv("fall2020dataCoHEJun17.csv")

#remove any doubles in the article's data
fall2020dataCoHEJun17 <- unique(fall2020dataCoHEJun17)

#separate anything with a dash, like California State University-Fresno with the specific campus being campus1
fall2020dataCoHEJun17 <- fall2020dataCoHEJun17 %>%
  separate(Institution, c("mainname", "campus1"), " — ")

#fall2020dataCoHEJun17 <- fall2020dataCoHEJun17[!duplicated(fall2020dataCoHEJun17$mainname), ]
...
bigList<-merge(x=fall2020dataCoHEJun17,y=Most_Recent_Cohorts_SMALL,by="mainname",all.x=TRUE)
...
ggplot(List, aes(y = Region)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE)) +
  labs(title="Colleges fall 2020 call by Region", caption = "Data from The Chronicle of Higher Education on 6/17/2020") +
  theme_few() +
...
ggplot(List, aes(y = Division)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE)) +
  labs(title="Colleges fall 2020 call by Division", caption = "Data from The Chronicle of Higher Education on 6/17/2020") +
  theme_few() +
  xlab("Number of schools") +
  ylab(" ")
...
ggplot(List, aes(y = Control)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE))  +
  labs(title="Public vs. Private school fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/17/2020") +
  theme_few() +
  xlab("Number of schools") +
  ylab(" ")
...
ggplot(List, aes(y = Call)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE))  +
  labs(title="All schools' fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/17/2020") +
  theme_few() +
  xlab("Number of schools") +
  ylab(" ")
...
ggplot(WomenOnly, aes(y = Call)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE)) +
  labs(title="Historically Women's Colleges' fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/17/2020") +
  theme_few() +
  xlab("Number of schools") +
  ylab(" ")
...
ggplot(MassOnly, aes(y = Call)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE)) +
  labs(title="Massachusetts schools' fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/17/2020") +
  theme_few() +
  xlab("Number of schools") +
  ylab(" ")
...
ggplot(List, aes(x = ADM_RATE, y = MEDIAN_HH_INC, color = Call)) +
  ...
  labs(title="Median Household Income, acceptance rate, and fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/17/2020") +
  theme_few()  +
...
ggplot(List, aes(x = ADM_RATE, y = PCT_BORN_US, color = Call)) +
  ...
  scale_y_continuous(trans = 'log10') +
  ylim(65,100) +
  labs(title="Percent of students born in the U.S., acceptance rate, and fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/17/2020") +
  theme_few()  +
  xlab("Acceptance Rate") +
...
ggplot(SelectiveSchool, aes(y = Region)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE))+
  labs(title="Selective schools' fall 2020 call by region", caption = "Data from The Chronicle of Higher Education on 6/17/2020") +
  theme_few()  +
  xlab("Number of schools") +
  ylab(" ")
...
ggplot(MassOnly, aes(y = Call)) +
 geom_bar(aes(fill = Call), position = position_stack(reverse = FALSE)) +
  labs(title="Massachusetts selective schools' fall 2020 call", caption = "Data from The Chronicle of Higher Education on 6/17/2020") +
  theme_few()  +
  xlab("Number of schools") +
  ylab(" ")
...
I began with The Chronicle of Higher Education article’s data. I opened it in Excell to change the formatting to account for each campus for schools with multiple campuses, such as the California State University system.
